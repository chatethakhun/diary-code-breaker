...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { content_type_id: @content.content_type_id } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { content_type_id: @content.content_type_id } }
